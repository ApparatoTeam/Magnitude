...
MagnitudeGame.prototype = {
    ...
    preload: function () {
        ...
        game.load.image('road', 'assets/road.png',100,100);
        ...
        game.load.spritesheet('btn-left', 'assets/btn-left.png',64,64);
        game.load.spritesheet('btn-right', 'assets/btn-right.png',64,64);
        game.load.spritesheet('btn-up', 'assets/btn-up.png',64,64);
        game.load.spritesheet('btn-down', 'assets/btn-down.png',64,64);
